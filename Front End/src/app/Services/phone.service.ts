...
export class PhoneService {
  ...
  BaseUrl: string = 'https://salester.bsite.net/api/UserProfile/get-phones';
  AddPhoneUrl: string = 'https://salester.bsite.net/api/UserProfile/add-phone';
  DeletePhoneUrl: string = 'https://salester.bsite.net/api/UserProfile/delete-phone'
