...
export class CartService {
  ...
  // ---------------- [ Urls ]
  CartUrl: string = "https://salester.bsite.net/api/UserCart/CartProducts"
  AddCartUrl: string = "https://salester.bsite.net/api/UserCart/AddProductToCart"
  DeleteCartUrl: string = "https://salester.bsite.net/api/UserCart/DeleteProductFromCart?productId="
  CartQuantityUrl: string = "https://salester.bsite.net/api/UserCart/EditCartProductQuntity?"
