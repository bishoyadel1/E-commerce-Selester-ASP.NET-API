...
export class ProductlistService {
  ...
  BaseUrl: string = "https://salester.bsite.net/api/Products/All";
  BaseUrlForSellerOrAdmin: string = "https://salester.bsite.net/api/Products/GetProductsListForMangement";
  ProductUrl: string = "https://salester.bsite.net/api/Products";
  ...
  getProductsForSellerOrAdmin(queryParams: IproductFilter): Observable<Iproduct[]> {
    ...
    return this.http.get<Iproduct[]>(this.BaseUrlForSellerOrAdmin, { params });
