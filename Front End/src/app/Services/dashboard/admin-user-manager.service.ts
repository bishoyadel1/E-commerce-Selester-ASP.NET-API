...
export class AdminUserManagerService {
  baseURL: string = 'https://salester.bsite.net/api/AdminUserManager';
  productCountUrl: string = 'https://salester.bsite.net/api/Products/GetProductsCount';
  ordersCountUrl: string = 'https://salester.bsite.net/api/Order/GetOrdersCount';
  totalSellUrl: string = 'https://salester.bsite.net/api/Order/TotalSell';
