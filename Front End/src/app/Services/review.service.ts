...
export class ReviewService {
  ...
  AllReviewsUrl: string = "https://salester.bsite.net/api/Review/GetAllReviews";
  AddReviewUrl: string = "https://salester.bsite.net/api/Review";
  baseURL: string = 'https://salester.bsite.net/api/Review'; // Tasneem
  ProductReviewUrl = 'https://salester.bsite.net/api/Review/GetReviewsByProductId/'
