        ...
        public static ICollection<ProductToReturnDto> Map(ICollection<Product> products)
        {
            ...
            foreach (Product product in products)
            {
                productToReturnDtos.Add(new ProductToReturnDto
                {
                    ...
                    Model = product.Model,
                    Color = product.Color,
                    ProductDetailone = product.ProductDetailone,
                    ProductDetailtwo = product.ProductDetailtwo,
                    ProductDetailthree = product.ProductDetailthree,
                    ProductDetailfour = product.ProductDetailfour,
                    ProductDetailfive = product.ProductDetailfive,
                    ProductDetailsix = product.ProductDetailsix,
                    ProductDetailsiven = product.ProductDetailsiven,
