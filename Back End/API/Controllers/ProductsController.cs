...
namespace API.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public IActionResult GetById(int id)
        {
            ...
            productToReturnDto.ProductDetailone = product.ProductDetailone;
            productToReturnDto.ProductDetailtwo = product.ProductDetailtwo;
            productToReturnDto.ProductDetailthree = product.ProductDetailthree;
            productToReturnDto.ProductDetailfour = product.ProductDetailfour;
            productToReturnDto.ProductDetailfive = product.ProductDetailfive;
            productToReturnDto.ProductDetailsix = product.ProductDetailsix;
            productToReturnDto.ProductDetailsiven = product.ProductDetailsiven;
        ...
        #region GetProductForSellerOrAdmin
        [HttpGet("GetProductsListForMangement")] //GET /api/products/all
        [Authorize(Roles = "Admin ,Seller")]
        public IActionResult GetProductsListForMangement([FromQuery] QueryParametars parametars)
        {
            ...
            {
                parametars.UserId = int.Parse(User.FindFirst(ClaimTypes.NameIdentifier)?.Value);
                ICollection<Product> products = productRepository.GetAllWithSpec(parametars);
                List<ProductToReturnDto> productsDto = new List<ProductToReturnDto>();
                if (products?.Count > 0)
                {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    var product = new Product
                    {
                        ...
                        ProductDetailone = Request.Form["ProductDetailone"],
                        ProductDetailtwo = Request.Form["ProductDetailtwo"],
                        ProductDetailthree = Request.Form["ProductDetailthree"],
                        ProductDetailfour = Request.Form["ProductDetailfour"],
                        ProductDetailfive = Request.Form["ProductDetailfive"],
                        ProductDetailsix = Request.Form["ProductDetailsix"],
                        ProductDetailsiven = Request.Form["ProductDetailsiven"],
        ...
        public async Task<IActionResult> Update()
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    existingProduct.ProductDetailone = Request.Form["ProductDetailone"];
                    existingProduct.ProductDetailtwo = Request.Form["ProductDetailtwo"];
                    existingProduct.ProductDetailthree = Request.Form["ProductDetailthree"];
                    existingProduct.ProductDetailfour = Request.Form["ProductDetailfour"];
                    existingProduct.ProductDetailfive = Request.Form["ProductDetailfive"];
                    existingProduct.ProductDetailsix = Request.Form["ProductDetailsix"];
                    existingProduct.ProductDetailsiven = Request.Form["ProductDetailsiven"];
