...
namespace API.Controllers
{
    ...
    public class AdminReportController : ControllerBase
    {
        ...
        [HttpGet("GetSellerProfitByDate")]
        public async Task<IActionResult> GetSellerProfitByDate(DateTime startDate, DateTime endDate)
        {
            var report = await reportRepository.GetProfitReportByDate(startDate, endDate);
